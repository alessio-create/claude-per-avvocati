...
export const mdxComponents: MDXComponentsType = {
  ...
  h1: (props: JSX.IntrinsicElements['h1']) => <h1 className="font-serif text-4xl font-bold mt-8 mb-4" {...props} />,
  h2: (props: JSX.IntrinsicElements['h2']) => <h2 className="font-serif text-2xl font-bold mt-10 mb-3" {...props} />,
  h3: (props: JSX.IntrinsicElements['h3']) => <h3 className="font-serif text-xl font-bold mt-8 mb-2" {...props} />,
  h4: (props: JSX.IntrinsicElements['h4']) => <h4 className="font-serif text-lg font-bold mt-6 mb-2" {...props} />,
  p: (props: JSX.IntrinsicElements['p']) => <p className="text-body leading-relaxed my-4" {...props} />,
